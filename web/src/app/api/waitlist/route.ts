        ...
        if (process.env.RESEND_API_KEY) {
            try {
                ...
                await resend.emails.send({
                    from: 'XPACE <contato@xpace.dance>',
                    to: [cleanEmail],
                    subject,
                    tags: [
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#0a0a0a;border:1px solid #1a1a1a;border-radius:12px;overflow:hidden;max-width:600px;width:100%">
        ...
        <tr>
          <td style="padding:40px">
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%">
              <tr>
                <td align="center">
                  <a href="https://xpace.dance" style="display:inline-block;background:linear-gradient(135deg,#6324b2,#eb00bc);color:#fff;font-weight:700;font-size:13px;letter-spacing:3px;text-transform:uppercase;text-decoration:none;padding:16px 40px;border-radius:6px">Visitar XPACE.DANCE</a>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="padding:24px 40px;border-top:1px solid #1a1a1a;text-align:center">
            <p style="margin:0;color:#444;font-size:12px;font-family:monospace">© 2026 XPACE • <a href="https://xpace.dance/privacidade" style="color:#555">Privacidade</a></p>
          </td>
        </tr>
      </table>
    </td></tr>
